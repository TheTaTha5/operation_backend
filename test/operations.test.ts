...
test('deployment capacity feeds availability, bookings, and manifest', async () => {
  ...
  assert.deepEqual(availability.json(), { route_id: 'r1', service_date: date, deployed_capacity: 10, total_capacity: 10, booked_pax: 0, charter_pax: 0, locked_pax: 0, available_seats: 10 });
